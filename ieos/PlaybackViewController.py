# ieos/PlaybackViewController.py
import os
import threading
import time
...
from gui.utils.usb.USBDriveManager import ensure_recordings_ready


class PlaybackViewController(ViewController[None]):
    """Plays a WAV file. Key2 stops playback and pops. No recording."""
    ...
    def __init__(self, file_path: str) -> None:
        ...
        self._status = MultilineTextView(
            0, 0,
            text=f"{label[:16]}\nPreparing...",
    ...
    def on_appear(self) -> None:
        ...
        base = os.path.basename(self._file_path)[:16]
